...
public class ApiConstants {
     ...
     * oa测试接口地址
     */
    public static final String OA_TEST_HOST = "http://rj.zzx1983.com:30008/";

    /**
     * 报纸期刊数据地址
     */
//    public static final String SEND_PAPER_HOST="http://10.71.16.121:8055/";
    public static String SEND_PAPER_HOST = "http://rj.zzx1983.com:30034/";
    /**
     * 发送硬件数据地址
     */
    public static String SEND_SOCKET_HOST = "http://192.168.103.188:8778/";
    // 精选列表
    ...
    public static String getHost(int hostType) {
        ...
        switch (hostType) {
            ...
            case HostType.NEWS_DETAIL_HTML_PHOTO:
                host = "http://kaku.com/";
                break;
            case HostType.OA_TEST:
                host = OA_TEST_HOST;
                break;
            case HostType.SEND_PAPER:
                host = SEND_PAPER_HOST;
                break;
            case HostType.SEND_SOCKET:
                host = SEND_SOCKET_HOST;
                break;
            default:
                host = "";
                break;
